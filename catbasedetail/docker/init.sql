...
'ใบหน้ากลม ดวงตาโต กลม จมูกสั้น หูเล็ก ปลายมน ลำตัวสั้น ขาใหญ่ กล้ามเนื้อแน่น ขนยาวหนานุ่ม มีชั้นขนละเอียด ที่ต้องได้รับการดูแลสม่ำเสมอ',
'นุ่มนวล รักสงบ อ่อนโยน ไม่ชอบเสียงดัง ชอบอยู่ในที่เงียบสงบ อบอุ่น ชอบนั่งใกล้เจ้าของ คลอเคลียเบาๆ เหมาะกับผู้เลี้ยงที่ใส่ใจในรายละเอียด',
...
'ใบหน้ากลม ดวงตากลมโตหลายสี จมูกสั้นโค้งเล็กน้อย ลำตัวขนาดกลางค่อนข้างอวบแต่มีกล้ามเนื้อ ขาปานกลาง หางยาวโค้งมน ขนหนานุ่มทั้งแบบสั้นและยาว สีและลายหลากหลาย จุดเด่นที่สุดคือใบหูที่พับมาด้านหน้า ทำให้หน้าดูหวานและน่ารัก',
'สุขุม เรียบร้อย ไม่ค่อยซุกซนหรือโลดโผน ชอบอยู่ใกล้และคลอเคลียเจ้าของ เข้ากับคนง่าย ปรับตัวกับบ้านใหม่ได้ดี มักมีท่าทางกวน ๆ น่ารัก เช่น นั่งท่าตุ๊กตาหมีหรือยืนสองขา เหมาะกับคนที่ต้องการแมวขี้อ้อนและบรรยากาศสงบในบ้าน',
...
'Maine Coon',
'United States',
'แมวพันธุ์ เมนคูน (Maine Coon) ถือเป็นแมวสายพันธุ์ขนยาวที่มีต้นกำเนิดจากการผสมข้ามพันธุ์ของแมวพื้นเมือง กับแมวป่าทางตอนเหนือของประเทศสหรัฐอเมริกา ซึ่งคำว่า “เมน” มาจากถิ่นกำเนิดคืออยู่ที่รัฐ Maine ประเทศสหรัฐอเมริกา ส่วนคำว่า “คูน” เชื่อกันว่าอาจมาจากพวกมันที่มีลักษณะคล้ายกับตัวแรคคูน คือ มีหางเป็นพวง มีสีและลวดลายสีน้ำตาลที่มีลักษณะเหมือนแรคคูนแมวพันธุ์เมนคูนเริ่มมีความนิยมลดลงในช่วงต้นปี ค.ศ. 1900 เนื่องจากได้มีการนำเข้าแมวจากยุโรปอย่างแมวเปอร์เซียที่มีขนาดเล็กกว่ามาก แต่ไม่นานกลุ่มอนุรักษ์สายพันธุ์แมวพื้นเมืองได้มีการจัดการแสดงนิทรรศการขึ้น ในปี ค.ศ. 1950 ทำให้ความนิยมของ “เมนคูน”กลับมาอีกครั้ง ทั้งในประเทศ ประเทศอังกฤษ และแพร่กระจายไปทั่วยุโรปในเวลาต่อมา',
'หัวใหญ่ หน้าผากกว้าง โหนกแก้มสูง มีอกว้าง ขนยาวหนา ใบหูชี้ตั้ง มีปลายแหลม และมีขนขึ้นที่ปลายหูคล้ายแมวป่า และมีอุ้งเท้าขนาดใหญ่',
'ฉลาด ว่านอนสอนง่าย ไม่กลัวคนแปลกหน้า ชอบเล่นน้ำ มีนิสัยใจเย็น เรียบร้อย ชอบใกล้ชิดผู้คนเป็นอย่างมาก สามารถปรับตัวเข้ากับสิ่งแวดล้อมได้ดี รวมถึงสามารถเข้ากับคนภายในครอบครัว',
'เคล็ดลับในการดูแล: ควรแปรงขนอย่างน้อยสัปดาห์ละ 2-3 ครั้ง เพื่อป้องกันการพันกันเป็นก้อนและลดขนร่วง หมั่นตัดเล็บเป็นประจำเพราะเล็บของแมวเมนคูนมักจะยาวและแข็งแรง ให้อาหารที่มีคุณภาพและเหมาะสมกับขนาดตัว และพาไปตรวจสุขภาพกับสัตวแพทย์เป็นประจำ เพื่อป้องกันโรคต่างๆ',
...
'ศีรษะรูปทรงสามเหลี่ยม หน้าผากลาด หูใหญ่ ดวงตาเป็นรูปอัลมอนด์ ลำตัวแข็งแรง มีกล้ามเนื้อ และมีขนาดใหญ่ หางยาว เป็นพวง และมักจะชูสูง ขนกึ่งยาว เป็นมันเงา และกันน้ำ มีขนชั้นในแน่น และมีสีสันหลากหลาย',
'น่ารัก อ่อนหวาน เป็นมิตร ปรับตัวเก่ง ชอบปีนป่าย ขี้เล่น และเข้าสังคมเก่ง',
'เคล็ดลับในการดูแล: แปรงขนอย่างน้อยสัปดาห์ละ 2 ครั้งและทุกวันในช่วงฤดูผลัดขน เพื่อให้แมวขจัดขนเก่าได้ ช่วยให้ขนของแมวอยู่ในสภาพที่ดี ไม่พันกัน และควรเช็ดมุมขอบตาของแมวนอร์วีเจียน ฟอเรสต์ทุกวัน โดยใช้ผ้าแยกกันสำหรับดวงตาแต่ละข้าง',
...
'แมวขนาดกลางถึงใหญ่ ตัวผู้ราว 6–9 กก. ตัวเมียประมาณ 4–7 กก. โครงสร้างใหญ่แน่น ดวงตากลมโตสีฟ้าสดใส ขนกึ่งยาว หนานุ่ม ไม่ค่อยพันกัน สีและลายหลากหลาย เช่น seal, blue, chocolate, lilac พร้อมลายยอดนิยมอย่าง colorpoint, mitted และ bicolor ทำให้ดูหรูหราและอบอุ่น',
'อ่อนโยน รักสงบ ชอบอยู่ใกล้และตามติดเจ้าของ มักยอมปล่อยตัวนิ่ม ๆ เมื่อตัวถูกอุ้มเหมือนตุ๊กตาผ้า เข้ากับเด็กและสัตว์เลี้ยงอื่นได้ดี เหมาะกับครอบครัวและคนที่ต้องการแมวขี้อ้อน ใช้ชีวิตร่วมกับคนได้แบบสบายๆ',
...
'แมวขนาดกลางถึงใหญ่ ตัวผู้ราว 5–7 กก. ตัวเมียประมาณ 3–5 กก. โครงสร้างแข็งแรงแน่น ขนยาวปานกลางหนานุ่ม มีสีพื้นอ่อนและลายสีเข้มตามใบหน้า หู ขา และหาง ดวงตากลมโตสีฟ้า สวยและมีเสน่ห์',
'อ่อนโยน เป็นมิตร ชอบอยู่ใกล้เจ้าของ เข้ากับเด็กและสัตว์เลี้ยงอื่นได้ดี มักนิ่งสงบและค่อนข้างขี้อ้อน เหมาะกับครอบครัวหรือคนที่ต้องการแมวรักสงบและนุ่มนวล',
...
เชื่อกันว่าสายพันธุ์นี้เกิดจากการผสมข้ามพันธุ์ระหว่าง แมวบ้านและแมวป่าในป่าไซบีเรีย ขนที่หนาและหนาแน่น เป็นการปรับตัวตามธรรมชาติเพื่อรับมือกับความหนาวเย็นจัดของรัสเซีย นอกจากนี้ยังเป็นที่รักของคนรักสัตว์ทั่วโลกเนื่องจากมีบุคลิกที่น่ารักและขี้เล่น',
'หัวกลมและกว้าง มีหน้าผากโค้งและปากกระบอกปืนที่ชัดเจน ตาใหญ่และเป็นรูปวงรี ขายาวและแข็งแรง มีอุ้งเท้าขนาดใหญ่ซึ่งช่วยให้เคลื่อนไหวบนหิมะได้',
'อ่อนหวาน เข้ากับคนง่าย มีความฉลาด มีความอยากรู้อยากเห็น ชอบปีนป่าย กระโดดและรักความเป็นอิสระ',
...
'Turkish Angora',
'Turkey',
'เป็นหนึ่งในสายพันธุ์แมวที่เก่าแก่ที่สุดในโลก โดยมีถิ่นกำเนิดจากประเทศตุรกี มีประวัติยาวนานและเกี่ยวข้องกับวัฒนธรรมท้องถิ่นของตุรกีเป็นอย่างมาก แมวพันธุ์นี้มีความโดดเด่นในเรื่องขนยาวนุ่มละเอียดและรูปลักษณ์ที่สง่างาม เป็นแมวที่มีรูปร่างเพรียวบาง น้ำหนักเบา และมีความคล่องแคล่วสูง แต่ถูกเหมารวมว่าเป็นแมวเปอร์เซียเพราะมีลักษณะขนยาวคล้ายกันแต่เมื่อปีค.ศ. 1962 มีชายผู้ช่วยอเมริกาได้เข้าไปทำงานในสวนสัตว์ในแองโกร่า
แล้วไปพบกับเจ้าแมวพันธุ์นี้เข้าจึงสังเกตเห็นความแตกต่างจากแมวเปอร์เซียหลายประการจึงนำเข้าไปเลี้ยงและพัฒนาสายพันธุ์ในอังกฤษ  โดยใช้เวลาทั้งสิ้นกว่า 45 ปี แมวเทอร์คิช แองโกร่า ถูกพัฒนาสายพันธุ์จนกระทั่งเป็นที่ยอมรับให้เป็นแมวสายพันธุ์เทอร์คิช แองโกร่า จาก CFA ในที่สุด',
'จะมีลำตัวยาว ขนเหมือนเส้นไหม ยาวและหนาเหมือนขนแกะ หางเล็ก คอสั้น หูตั้ง ลูกนัยน์ตากลมรี ขายาวกว่าแมวเปอร์เซีย อุ้งเท้าเล็กค่อนข้างกลมมน สะโพกใหญ่  ตรงแผงคอจะมีขนยาว หน้าท้องมีขนดก ที่นิ้วเท้าและปลายหูมีขนเป็นกระจุก ขนสีขาว นัยน์ตาสีฟ้า ทองแดง เขียว ทองและตาสองสี อุ้งฝ่าเท้า ริมฝีปาก และจมูกสีชมพู',
'ฉลาด คล่องแคล่ว ขี้เล่น มีพลังงานสูงแต่ก็อ้อนเจ้าของมาก ชอบอยู่ใกล้คน ชอบปีนป่ายและสำรวจ ติดคนพอสมควร เข้ากับเด็กและสัตว์เลี้ยงอื่นได้ดี เหมาะกับบ้านที่มีเวลาให้เล่นหรือมีพื้นที่ให้ปีน',
...
'Ragamuffin',
'United States',
'ประวัติของแมวสายพันธุ์นี้เริ่มต้นขึ้นในปี ค.ศ. 1960  คุณ Ann Baker ซึ่งเป็นผู้ที่เพาะพันธุ์แมวสายพันธุ์ Ragdoll เป็นครั้งแรก หลังจากที่เธอทำการเพาะพันธุ์เจ้า Ragdoll สำเร็จแล้ว เหล่าบรรดาผู้เพาะพันธุ์แมวท่านอื่นต้องการที่จะเพิ่มความหลากหลายให้กับสีขน ขนาดตัว และลักษณะภายนอกในแมวชนิดนี้ แต่ว่าคุณ Ann Baker นั้นไม่เห็นด้วยกับการกระทำดังกล่าว กลุ่มผู้เพาะพันธุ์แมวบางส่วนจึงได้ออกมาทำการทดลองเพาะพันธุ์แมวเอง
เหล่าผู้เพาะพันธุ์กลุ่มนี้ได้ทำการนำเจ้า Ragdoll มาผสมข้ามสายพันธุ์กับแมวพันธุ์ Persain, Himalayan, และแมวบ้านที่มีขนยาวชนิดอื่น ขนมันกลายออกมาเป็นแมวสายพันธุ์ใหม่ที่มีชื่อว่า Ragamuffin ที่พวกเรารู้จักกัน ที่มีสีตาและสีขนที่แตกต่างจากเจ้า Ragdoll และแล้วมันก็ได้รับการยอมรับอย่างเป็นทางการจากองค์กร Cat Fanciers’ Association ในปี ค.ศ. 2011',
'มีขนาดใหญ่ ตัวแน่น โครงร่างเป็นทรงคล้ายสี่เหลี่ยมผืนผ้า อกกว้าง มีความทรงพลัง ใบหน้าน่ารัก ด้วยรูปตาที่เป็นทรงคล้ายลูกวอลนัท ใบหูมีขนปกคลุม ท่าทีดูสง่างาม มาพร้อมกับขนกึ่งยาวที่มีสัมผัสนุ่มฟู เสริมไปด้วยแผงคอยาวสลวย ขนหางฟู ๆ และอุ้งเท้าฟูนุ่ม',
'ฉลาด เข้าใจง่าย ไม่ก้าวร้าว อ่อนหวาน ผ่อนคลาย เจ้าเสน่ห์ ขี้เล่นขี้สงสัย เข้ากับคนง่ายและต้องการการดูแล',
'เคล็ดลับในการดูแล: แปรงขน 2–3 ครั้งต่อสัปดาห์ เพื่อป้องกันขนพันกันและขนร่วง จะเติบโตได้ดีด้วยการรับประทานอาหารที่มีโปรตีนสูง และคาร์โบไฮเดรตต่ำซึ่งช่วยป้องกันโรคอ้วน พาไปเดินบ่อยๆเป็นการออกกำลังกาย และ เอาใจใส่มากๆเนื่องจากมีความเสี่ยงเป็นโรคทางพันธุกรรมสูง ',
...
'ขนาดกลาง ตัวเพรียว athletic กล้ามเนื้อดี ใบหน้ารูปสามเหลี่ยมอ่อน ๆ หูใหญ่ ดวงตาโตสีทอง/เขียว ขนยาวปานกลาง ฟูรอบคอและหาง (หางฟูเหมือนจิ้งจอก)',
'ขี้เล่น ขยับตัวทั้งวันไม่ค่อยอยู่นิ่ง ชอบปีนป่าย สำรวจ และเล่นกับคน เป็นมิตร ติดเจ้าของ ฉลาด ช่างสังเกตและอยากรู้อยากเห็น',
